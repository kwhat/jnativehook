...
/* Unknown Extended Keyboard Codes */
	 ...
	 * event.
	 * @param keyCode The virtual key code generated by this event, or VK_UNDEFINED (for a key-typed event)
	...
	/**
	 * Returns the keyboard character associated with this event.
	 *
	 * @return The keyboard character defined for this key event. If no valid Unicode character exists for this key event, CHAR_UNDEFINED is returned.
	 */
	...
	/**
	 * Set the keyChar value in this event.  For example, the key-typed event
