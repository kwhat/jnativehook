...
#include "VirtualModiferMasks.h"
#include "VirtualMouseButtons.h"

uint_fast16_t ConvertToNativeKey(uint_fast16_t VirtualKeyCode) {
	VirtualKeyEvent event;
	event.rawcode = VirtualKeyCode;
...
uint_fast8_t ConvertToNativeButton(uint_fast8_t virtualButton) {
	uint_fast8_t nativeButton;
...
uint_fast16_t ConvertToNativeMask(uint_fast16_t virtualMask) {
	uint_fast16_t nativeMask = 0x0000;
