...
uint_fast16_t convert_to_native_key(uint_fast16_t virtual_keycode) {
	VirtualKeyEvent event;
	event.rawcode = virtual_keycode;
...
uint_fast8_t convert_to_native_button(uint_fast8_t virtual_button) {
	uint_fast8_t virtual_button1;
	
	switch (virtual_button) {
		case NH_BUTTON1:
			virtual_button1 = Button1;
		case NH_BUTTON2:
			virtual_button1 = Button2;
		case NH_BUTTON3:
			virtual_button1 = Button3;
		case NH_BUTTON4:
			virtual_button1 = Button4;
		case NH_BUTTON5:
			virtual_button1 = Button5;

		default:
		case VC_NOBUTTON:
			virtual_button1 = AnyButton;
	}
	
	return virtual_button1;
}

uint_fast16_t convert_to_native_mask(uint_fast16_t virtual_mask) {
	uint_fast16_t native_mask = 0x0000;
