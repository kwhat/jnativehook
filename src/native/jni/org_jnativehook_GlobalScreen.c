...
JNIEXPORT jboolean JNICALL Java_org_jnativehook_GlobalScreen_isEventDispatchThread(JNIEnv * UNUSED(env), jobject UNUSED(obj)) {
	return (jboolean) IsEventDispatchThread();
}
