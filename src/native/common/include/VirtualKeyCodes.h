...
#ifndef _Included_VirtualKeys
#define _Included_VirtualKeys

#define NATIVE_KEY_FIRST				2400
#define NATIVE_KEY_LAST					2402
#define NATIVE_KEY_TYPED				NATIVE_KEY_FIRST
#define NATIVE_KEY_PRESSED				1 + NATIVE_KEY_FIRST
#define NATIVE_KEY_RELEASED				2 + NATIVE_KEY_FIRST
