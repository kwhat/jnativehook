...
JKeyCode NativeToJKeyCode ( unsigned int keycode ){
	...
	switch (keycode) {
		...
		case VK_NUMPAD0:								jkey.keycode = JK_0; 							return jkey;
		case VK_NUMPAD1:								jkey.keycode = JK_1; 							return jkey;
		case VK_NUMPAD2:								jkey.keycode = JK_2; 							return jkey;
		case VK_NUMPAD3:								jkey.keycode = JK_3; 							return jkey;
		case VK_NUMPAD4:								jkey.keycode = JK_4; 							return jkey;
		case VK_NUMPAD5:								jkey.keycode = JK_5; 							return jkey;
		case VK_NUMPAD6:								jkey.keycode = JK_6; 							return jkey;
		case VK_NUMPAD7:								jkey.keycode = JK_7; 							return jkey;
		case VK_NUMPAD8:								jkey.keycode = JK_8; 							return jkey;
		case VK_NUMPAD9:								jkey.keycode = JK_9; 							return jkey;

		case VK_OEM_1:									jkey.keycode = JK_SEMICOLON; 					return jkey;

		case VK_A:										jkey.keycode = JK_A; 							return jkey;
		case VK_B:										jkey.keycode = JK_B; 							return jkey;
		case VK_C:										jkey.keycode = JK_C; 							return jkey;
		case VK_D:										jkey.keycode = JK_D; 							return jkey;
		case VK_E:										jkey.keycode = JK_E; 							return jkey;
		case VK_F:										jkey.keycode = JK_F; 							return jkey;
		case VK_G:										jkey.keycode = JK_G; 							return jkey;
		case VK_H:										jkey.keycode = JK_H; 							return jkey;
		case VK_I:										jkey.keycode = JK_I; 							return jkey;
		case VK_J:										jkey.keycode = JK_J; 							return jkey;
		case VK_K:										jkey.keycode = JK_K; 							return jkey;
		case VK_L:										jkey.keycode = JK_L; 							return jkey;
		case VK_M:										jkey.keycode = JK_M; 							return jkey;
		case VK_N:										jkey.keycode = JK_N; 							return jkey;
		case VK_O:										jkey.keycode = JK_O; 							return jkey;
		case VK_P:										jkey.keycode = JK_P; 							return jkey;
		case VK_Q:										jkey.keycode = JK_Q; 							return jkey;
		case VK_R:										jkey.keycode = JK_R; 							return jkey;
		case VK_S:										jkey.keycode = JK_S; 							return jkey;
		case VK_T:										jkey.keycode = JK_T; 							return jkey;
		case VK_U:										jkey.keycode = JK_U; 							return jkey;
		case VK_V:										jkey.keycode = JK_V; 							return jkey;
		case VK_W:										jkey.keycode = JK_W; 							return jkey;
		case VK_X:										jkey.keycode = JK_X; 							return jkey;
		case VK_Y:										jkey.keycode = JK_Y; 							return jkey;
		case VK_Z:										jkey.keycode = JK_Z; 							return jkey;
