 ...
 * <p/>
 * This low-level event is generated by the system when a key is pressed, 
 * released. The event is passed to every KeyListener or KeyAdapter object which registered to receive such events using the component's addKeyListener method. (KeyAdapter objects implement the KeyListener interface.) Each such listener object gets this KeyEvent when the event occurs.  
 */
public class NativeKeyEvent extends NativeInputEvent {
	 ...
	 * <s>Always returns VK_UNDEFINED for NATIVE_KEY_TYPED events.</s>
	 */
	 ...
	 * <s>Always returns KEY_LOCATION_UNKNOWN for NATIVE_KEY_TYPED events.</s>
	 */
